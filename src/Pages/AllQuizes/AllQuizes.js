					...
					<div className='w-full lg:w-80 lg:my-0 lg:mr-6 h-screen py-8 bg-orange-50 border-r lg:fixed right-0 top-20 shadow-lg rounded-lg'>
						...
						<div className='flex flex-col items-center mt-6 -mx-2'>
							<img
								...
								alt='avatar'
							/>
							<h4 className='mx-2 mt-2 font-medium text-gray-800  hover:underline'>John Doe</h4>
							<p className='mx-2 mt-1 text-sm font-medium text-gray-600  hover:underline'>john@example.com</p>
						</div>
